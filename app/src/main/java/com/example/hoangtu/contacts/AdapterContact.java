...
public class AdapterContact extends ArrayAdapter<Contact> {
    ...
    public AdapterContact(@NonNull Context context,@NonNull ArrayList<Contact> objects) {
    ...
    public View getView(int position, @Nullable View v, @NonNull ViewGroup parent) {
        ...
        if (v==null){
            ...
            v = inflater.inflate(R.layout.layout_contact,parent,false);
            viewHolder.tvAvatar = v.findViewById(R.id.txtAvatar);
            viewHolder.tvName = v.findViewById(R.id.tvName);
            viewHolder.tvSex = v.findViewById(R.id.tvSex);
            viewHolder.tvNumber = v.findViewById(R.id.tvNumber);
        ...
        viewHolder.tvName.setText(contact.getHoTen());
        viewHolder.tvSex.setText(contact.getGioiTinh());
        viewHolder.tvNumber.setText(contact.getSdt());

        String chuoi = contact.getHoTen().substring(0,1);
        viewHolder.tvAvatar.setText(chuoi);
        ...
        viewHolder.tvAvatar.setBackground(shape);
